class Module {
  Module({required this.topic, required this.subTopics});
  final String topic;
...
List<Module> modules = [
  ...
  Module(topic: 'Deceptive Investment Frauds', subTopics: [
  ...
  Module(topic: 'Online Banking and Payment Fraud', subTopics: [
